...
import ndhgoPic from "../../../asset/Images/NDHGO-Logo.webp";
                        ...
                        <div className="work_profile">
                            ...
                            <CardActionArea className="project_body">
                                <div className="project_pic">
                                    <img src={WorkProfile.projectImg} alt={WorkProfile.projectName} />
                                </div>
            ...
            <div className="for_mobile">
                {
                    techwelfareProjrct.map((techwelfareProjrct) => (
                        <div className="work_profile">
                            <CardActionArea className="project_body">
                                <div className="project_pic">
                                    <img src={techwelfareProjrct.projectImg} alt={techwelfareProjrct.projectName} />
                                </div>
                                <div className="project_info">
